...
st.header("""
INTRODUCCIÓN:
La presencia del agua en los vacíos de un suelo afecta el comportamiento de los suelos finos, por lo cual es importante conocer su cantidad. Si conocemos el contenido de agua del suelo relativo a los límites de Atterberg tendremos una idea acerca de su comportamiento en el área de ingenieria""")
